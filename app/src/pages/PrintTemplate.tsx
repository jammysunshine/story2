...
export default function PrintTemplate() {
  ...
  return (
    <div className="print-container bg-[#FFFEF5] min-h-screen">
      {/* Title Page */}
      <div className="page relative w-[2400px] h-[3300px] overflow-hidden flex flex-col items-center justify-center p-20">
      ...
      {book.pages.map((page: any, i: number) => (
        <div key={i} className="page relative w-[2400px] h-[3300px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md p-24 pt-32 pb-40 text-center">
            ...
            <div className="mt-12 text-[32px] font-black text-blue-600/40 uppercase tracking-widest">
