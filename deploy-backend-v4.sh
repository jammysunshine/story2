...
gcloud run deploy storytime-backend \
    ...
    --set-env-vars \
        NODE_ENV=production,LOG_LEVEL=debug,GCP_PROJECT_ID=$PROJECT_ID,GCS_IMAGES_BUCKET_NAME=storytime-images-1768-sydney,GCS_PDFS_BUCKET_NAME=storytime-pdfs-1768-sydney,IMAGE_GENERATION_SERVICE=GOOGLE_IMAGEN,STORY_PAGES_COUNT=23,BASE_CURRENCY=aud,STORY_TEASER_PAGES_COUNT=7,CREDITS_PER_BASE_CURRENCY=1,IMAGE_GENERATION_DELAY_MS=15000,STORY_REF_CONCURRENCY=2,STORY_IMAGE_CONCURRENCY=30,ALLOW_DEV_LOGIN=false,PRINT_MIN_PAGES=10,PRINT_PAGE_COST=4,PRINT_SHIPPING_COST=10,MOBILE_MODE=true \
    --set-secrets \
