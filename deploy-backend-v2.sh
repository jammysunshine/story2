...
echo "🚀 Deploying Mobile Backend to Google Cloud Run (Simplified)..."
...
docker build -f Dockerfile.backend -t australia-southeast1-docker.pkg.dev/storytime-app-1768719813/ai-storytime-backend/storytime-backend:latest .
if [ $? -eq 0 ]; then
